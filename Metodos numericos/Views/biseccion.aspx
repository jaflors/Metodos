<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Inicio.Master" AutoEventWireup="true" CodeBehind="biseccion.aspx.cs" Inherits="Metodos_numericos.Views.biseccion" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceholder2" runat="server">
    ...
    <div class="col-lg-4 col-md-4 col-sm-12">
        ...
        <div class="showback">
            <h4><i class="fa fa-angle-right"></i>Bisección</h4>
            ...
            <div class="row form-group">
              <label class="col-sm-2 col-sm-2 control-label">a</label>
                <div class="col-sm-6">
                    <asp:TextBox ID="textBoxX1" onkeypress="javascript:return onKeyDecimal(event,this)" class="form-control" runat="server"  required="required"></asp:TextBox>
                </div>
            </div>
            <div class="row form-group">
                <label class="col-sm-2 col-sm-2 control-label">b</label>
                <div class="col-sm-6">
                    <asp:TextBox ID="textBoxX2" onkeypress="javascript:return onKeyDecimal(event,this)" class="form-control" runat="server" required="required"></asp:TextBox>
                </div>
            </div>
            <div class="row form-group">
                <label class="col-sm-2 col-sm-2 control-label">Error</label>
                <div class="col-sm-10"> 
                    <asp:TextBox ID="Text_error" onkeypress="javascript:return onKeyDecimal(event,this)" class="form-control" runat="server" required="required"></asp:TextBox>
                </div>
